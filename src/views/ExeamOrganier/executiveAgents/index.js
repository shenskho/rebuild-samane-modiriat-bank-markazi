...
export default function Index() {
  ...
  const mockLicenses = [
    ...
    },
    {
      id: 2,
      name: 'زهرا کریمی',
      province: 'حوزه اصفهان',
      phone: '09351234567',
      nationalId: '1122334455',
      typeOfActivity: 'آزمون گر',
      rank: 'خوب',
      presenter: 'ندارد',
      ...
      <Col lg={12}>
        <Row className='mb-2'>
          <p className='route-base-color'>
            ...
            <span className='route-caption'>عوامل اجرایی مجری </span>
          </p>
        </Row>
        <div>
                  ...
                  <Card id='Home' className='card-back-none'>
                    <CardHeader>
                      <div className='d-flex justify-content-between w-100'>
                        <h4 className='pt-1'> عوامل اجرایی مجری </h4>
                        ...
                        <Col lg={3} md={4} sm={6} key={item.id} className='d-flex justify-content-center'>
                          <div className='scope-card'>
                            <div className='d-flex justify-content-between'>
                              ...
                              <h4>{item.name}</h4>
                              <span className='scope-active'>درانتظار</span>
                            </div>
                            ...
                            <p className='scope-title'>
                              نوع فعالیت : <span className='scope-value'>{item.typeOfActivity}</span>
                            </p>
                            <p className='scope-title'>
