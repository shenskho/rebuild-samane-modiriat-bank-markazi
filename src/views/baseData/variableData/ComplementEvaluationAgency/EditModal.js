...
import { updateComplementEvaluationAgency, GetComplementEvaluationAgency } from '@store/slices/variableData'
...
export default function LicenseModal({ IsEditModal, SetIsEditModal, item }) {
  ...
  const {
    ...
    defaultValues: {
      title: item?.title || '',
      licenseExpireDate: item?.licenseExpireDateShamsi || '',
      mangerFullname: item?.mangerFullname || '',
      provinceId: item?.provinceId || '',
      mobile: item?.mobile || '',
      activityScopeId: item?.activityScopeId || '',
 ...
 console.log('licenseData (miladi)', payload)
    ...
    dispatch(updateComplementEvaluationAgency(payload)).then(() => {
          ...
          <Row>
            ...
            <Col lg={6}>
              <div className='mb-1'>
                ...
                />
                {errors.activityScopeId && (
                  <FormFeedback className='d-block'>{errors.activityScopeId.message}</FormFeedback>
                )}
              </div>
            </Col>
            ...
            <Col lg={6}>
              <div className='mb-1'>
                ...
                <Controller
                  ...
                  control={control}
                  render={({ field }) => (
                    <Input type='switch' checked={field.value} onChange={(e) => field.onChange(e.target.checked)} />
                  )}
                />
