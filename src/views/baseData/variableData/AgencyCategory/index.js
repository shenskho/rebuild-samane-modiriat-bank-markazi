...
import { GetAgencyCategory } from '@store/slices/variableData'
...
export default function index() {
  ...
  const rowsWithIndex = store.AgencyCategory.items?.map((item, i) => ({
  ...item,
    ...
    <Row>
      <Col lg={12}>
        <p className='route-base-color'>
          ...
          <span className='route-caption' onClick={()=> navigate("/AgencyCategory")}>رسته عوامل مجری </span>
        </p>
      </Col>
