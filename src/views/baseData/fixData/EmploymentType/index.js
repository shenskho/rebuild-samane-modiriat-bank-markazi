...
import { GetEmploymentType } from '@store/slices/fixData'
...
export default function index() {
  ...
  const rowsWithIndex = store.EmploymentType.items?.map((item, i) => ({
  ...item,
    ...
    <Row>
      <Col lg={12}>
        <p className='route-base-color'>
          ...
          <span className='route-caption' onClick={()=> navigate("/EmploymentType")}>نوع استخدام </span>
        </p>
      </Col>
