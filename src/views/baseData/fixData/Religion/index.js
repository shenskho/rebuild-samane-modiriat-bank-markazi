...
import { GetReligion } from '@store/slices/fixData'
...
export default function index() {
  ...
  const rowsWithIndex = store.Religion.items?.map((item, i) => ({
  ...item,
    ...
    <Row>
      <Col lg={12}>
        <p className='route-base-color'>
          ...
          <span className='route-caption' onClick={()=> navigate("/Religion")}>مذهب </span>
        </p>
      </Col>
