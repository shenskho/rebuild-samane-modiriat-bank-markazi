    ...
    <Row>
      <Col lg={12}>
        <p className='route-base-color'>
          <span className='first-route-selected' onClick={()=> navigate("/") } style={{cursor:'pointer'}}>خانه</span> / <span className='route-caption' >اطلاعات پایه</span> /{' '}
          <span className='route-captionz' onClick={()=>navigate("/fixData")} style={{cursor:'pointer'}}>اطلاعات ثابت</span> /{' '}
          <span className='route-caption' onClick={()=>navigate("/organization")} style={{cursor:'pointer'}}>دستگاه اجرایی</span>
        </p>
      </Col>
