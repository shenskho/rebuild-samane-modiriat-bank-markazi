...
import { getProvince } from '@store/slices/fixData'
...
export default function index() {
  ...
  const rowsWithIndex = store.Province.items?.map((item, i) => ({
  ...item,
    ...
    <Row>
      <Col lg={12}>
        <p className='route-base-color'>
          ...
          <span className='route-caption' onClick={()=> navigate("/Province")}>نوع مکان جغرافیایی </span>
        </p>
      </Col>
