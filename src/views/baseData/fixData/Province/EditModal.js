...
import { updateProvince, getProvince } from '@store/slices/fixData'
...
export default function EditModal({ IsEditModal, SetIsEditModal, item }) {
  ...
  return (
    <Modal size='lg' isOpen={IsEditModal} toggle={toggle}>
      <ModalHeader toggle={toggle}>تغییر نوع مکان جغرافیایی</ModalHeader>

      <ModalBody>
        <Label>نوع مکان جغرافیایی جدید خود را وارد کنید</Label>
