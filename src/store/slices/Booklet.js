...
export const GetAllBooklet = createAsyncThunk('Booklet/getAllBooklet', async () => {
  const response = await apis.getAllBooklet()
...
export const Booklet = createSlice({
  ...
  extraReducers: (builder) => {
    ...
    }).addCase(GetAllBooklet.fulfilled, (state, action) => {
